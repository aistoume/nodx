...
# ${BASH_SOURCE[0]:-$0}: when piped (`curl … | bash -s -- <id>`) BASH_SOURCE
# is unset and set -u would abort — fall back to $0 ("bash"), which makes
# SCRIPT_DIR "." and triggers the download path below.
