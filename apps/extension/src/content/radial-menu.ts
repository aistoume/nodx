...
/** Text-selection actions — single level, all leaves, labels shown. */
export const TEXT_OPTIONS: RadialOption[] = [
  { emoji: '📖', label: '解释', angleDeg: 0, bg: 'rgba(59, 130, 246, 0.95)', choice: 'txt-explain' },
  { emoji: '📚', label: '深入', angleDeg: 90, bg: 'rgba(217, 119, 6, 0.95)', choice: 'txt-deepen' },
  { emoji: '🔎', label: '搜索', angleDeg: 180, bg: 'rgba(16, 185, 129, 0.95)', choice: 'txt-search' },
  { emoji: '📋', label: '复制', angleDeg: 270, bg: 'rgba(168, 85, 247, 0.95)', choice: 'txt-copy' },
];
